package com.example.ensights.imagepipeline;
...
public class ImageActions {
     ...
     * @param requestCode request code to get result when the camera activity is
     *                    dismissed.
     */
     ...
     * 
     * @param activity    origin activity in which the intent will be from.
     * @param requestCode request code to get result when the gallery activity is
     *                    dismissed.
     */
